...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference("Wishlist.count") do
      post wishlists_url, params: { wishlist: { description: @wishlist.description, family_member_id: @wishlist.family_member_id, link: @wishlist.link, purchased: @wishlist.purchased, quantity: @wishlist.quantity } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { description: @wishlist.description, family_member_id: @wishlist.family_member_id, link: @wishlist.link, purchased: @wishlist.purchased, quantity: @wishlist.quantity } }
