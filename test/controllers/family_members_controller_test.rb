...
class FamilyMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_member" do
    assert_difference("FamilyMember.count") do
      post family_members_url, params: { family_member: { first_name: @family_member.first_name, relationship: @family_member.relationship, user_id: @family_member.user_id } }
    end
  ...
  test "should update family_member" do
    patch family_member_url(@family_member), params: { family_member: { first_name: @family_member.first_name, relationship: @family_member.relationship, user_id: @family_member.user_id } }
